    ...
    try {
      ...
      const saved = await prisma.roast.create({
        data: {
          ...
          brutalityLevel,
          overallScore: roastResult.overallScore || 5,
          vibe: roastResult.vibe || 'Unknown',
          totalMonthlyLoss: roastResult.totalMonthlyLoss || 0,
          yearlyLoss: roastResult.yearlyLoss || 0,
          scoresJson: JSON.stringify({
            firstImpression: roastResult.firstImpression || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            copywriting: roastResult.copywriting || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            visualDesign: roastResult.visualDesign || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            ctaClarity: roastResult.ctaClarity || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            mobileFriendliness: roastResult.mobileFriendliness || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            loadingSpeed: roastResult.loadingSpeed || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            trustSignals: roastResult.trustSignals || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
            aboveTheFold: roastResult.aboveTheFold || { score: 5, roast: 'N/A', fix: 'N/A', moneyImpact: 0 },
          }),
