  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose prose-invert max-w-none space-y-4 text-ash-300">
        ...
        <p>All data is transmitted over SSL/TLS. Payments are processed by Stripe — we never see or store your credit card details. Authentication is handled by NextAuth.js with industry-standard OAuth 2.0.</p>
        <h2 className="font-display text-xl text-white">4. Third Parties</h2>
        <p>We use OpenAI for AI roast generation, Stripe for payments, and Google/GitHub for authentication. Each provider has its own privacy policy. We don&apos;t sell your data to anyone.</p>
